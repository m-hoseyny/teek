      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="glass rounded-2xl p-8 border border-border">
          <div className="mb-6">
            ...
            <p className="text-gray-400">Start creating viral content in minutes</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full h-12 pl-11 pr-4 bg-input border border-border rounded-lg text-white placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary transition-all"
                />
              </div>
            </div>
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full h-12 bg-gradient-purple hover:bg-gradient-purple-hover glow-purple font-semibold"
            >
              {isLoading ? (
                <>
          ...
          <div className="space-y-3">
            <Button
              type="button"
              variant="outline"
              className="w-full h-12 border-border hover:border-primary"
            >
